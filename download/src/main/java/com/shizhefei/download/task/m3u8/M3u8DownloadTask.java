...
public class M3u8DownloadTask extends AbsDownloadTask {
    ...
    public M3u8DownloadTask(long downloadId, DownloadInfo.Agency downloadInfoAgency, DownloadDB downloadDB, Executor executor, boolean isOnlyRemove) {
        this(downloadId, downloadInfoAgency, downloadDB, executor, isOnlyRemove, null);
    }

    public M3u8DownloadTask(long downloadId, DownloadInfo.Agency downloadInfoAgency, DownloadDB downloadDB, Executor executor, boolean isOnlyRemove, Func1<String, String> transformRealUrl) {
        this.executor = executor;
        downloadTask = new M3u8DownloadTaskImp(downloadId, downloadInfoAgency, downloadDB, isOnlyRemove, transformRealUrl);
    }
